...
// Follow ISO3166-1 Standard
// links: https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3
...
const regions = [
  ...
  { name: "Korea (the Democratic People's Republic of)", iso2: "KP", iso3: "PRK" },
  { name: "Korea (the Republic of)", iso2: "KR", iso3: "KOR" },
  ...
  { name: "Republic of North Macedonia", iso2: "MK", iso3: "MKD" },
